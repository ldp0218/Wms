...
@Poko
@JsonIgnoreProperties(ignoreUnknown = true)
data class Rkmx(val xsd_bz_id: Int?, var mx_num: Int, val scd_no: String?, val pro_name: String, val bz_id: Int, val bz_code: String, val pro_id: Int)
...
data class Baozhuang(val xsd_bz_id: Int, val bz_id: Int, val pro_id: Int, val pro_name: String,
                     ...
                     val xsdmx_instruction: String?, val yx: Int, val kc_num: Int)
