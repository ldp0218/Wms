...
data class Jhmx(val ck_id: Int, val hj_name: String?, val jh_id: Int, val jhdmx_id: Int, val jhdmx_num: Int, var scan_num: Int,
                val jhmx_id: Int, val ma_code: String, val ma_id: Int, val ma_model: String, val ma_name: String,
                val ma_spec: String, val ma_txm: String, var mx_num: Int, val mx_price: Double, val mx_remark: String, val mx_unit: String)
